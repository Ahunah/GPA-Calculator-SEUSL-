...
class ForthApp extends StatefulWidget {
  const ForthApp({super.key});

  @override
  State<ForthApp> createState() => _ForthAppState();
}

class _ForthAppState extends State<ForthApp> {
  final List<Map<String, dynamic>> subjects = [
    {"name": "Final Year Research Project", "credits": 6},
    {"name": "Industrial Training/Internship", "credits": 6},
    {"name": "E-Commerce", "credits": 2},
    {"name": "Strategic Management", "credits": 2},
  ];

  final List<String?> selectedGrades = List.filled(4, null);
